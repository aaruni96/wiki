...
This file recreates the wiki, but with classes. Hacking around is not allowed in this file.
...
//read() is in class io.
//write() is in class io.
//search() is in class io.
//prindex() is in class io.
